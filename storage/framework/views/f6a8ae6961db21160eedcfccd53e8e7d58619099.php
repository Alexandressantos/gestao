...
<body>
     <div class="cadastro-form">
        ...
        <?php echo csrf_field(); ?>
            ...
            <div class="form-group">
                <input type="text" class="form-control item" id="sobrenome" name="sobrenome" placeholder="sobrenome" value = "<?php echo e(old('sobrenome')); ?>" autocomplete="off">
            ...
            <div class="form-group">
                <input type="tel" class="form-control item" id="telefone" name="telefone" placeholder="Telefone" value = "<?php echo e(old('telefone')); ?>" autocomplete="off">
            ...
            <select class="form-group item" id="empresa" name="cd_emp">
             ...
             <?php $__currentLoopData = $empresas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $empresa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($empresa->cd_emp); ?>"><?php echo e($empresa->nome); ?></option>
             <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
             
              </select>
            </div>
             <?php if($errors -> has('cd_emp')): ?>
                  <font color="red">  <?php echo e($errors-> first('cd_emp')); ?> </font>
             <?php endif; ?>

            <div class="form-group">
                <button type="submit" class="btn btn-block criar-conta">Cadastrar Funcionário</button>
            </div>
...
<?php /**PATH C:\Users\a.santos.admin\Documents\code\gestao\resources\views/cadastro/cadastro_funcionario.blade.php ENDPATH**/ ?>